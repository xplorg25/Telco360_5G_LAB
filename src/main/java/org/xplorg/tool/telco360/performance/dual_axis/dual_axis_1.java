...
public dual_axis_1(dual_axis_2 chart, dual_axis_1a title, dual_axis_3 xAxis, ArrayList<dual_axis_5> yAxis,
		dual_axis_6 tooltip, ArrayList<dual_axis_7> series) {
	super();
	this.chart = chart;
	this.title = title;
	this.xAxis = xAxis;
